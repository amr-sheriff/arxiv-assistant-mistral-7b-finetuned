# -*- coding: utf-8 -*-
"""arxiv_model_LoRA_instruction_finetuning.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/14O1H0K0G13a1Jh2QdAJUY-Yuor4ynneQ
"""
...
# %cd drive/My Drive/Colab Notebooks/Stanford/CS224N/final-project/finetuning

# ! lspip3 install torch torchvision torchaudio --index-url https://download.pytorch.org/whl/cu118
...
#     decoded_preds = [pred.decode('utf-8') if isinstance(pred, bytes) else pred for pred in predictions]
#     decoded_labels = [label.decode('utf-8') if isinstance(label, bytes) else label for label in labels]

#     # Tokenize the predictions and labels
#     decoded_preds = [nltk.tokenize.word_tokenize(pred) for pred in decoded_preds]
#     decoded_labels = [[nltk.tokenize.word_tokenize(label)] for label in decoded_labels]

#     # Compute BLEU score
#     bleu = bleu_metric.compute(predictions=decoded_preds, references=decoded_labels)

#     # Compute ROUGE score
#     rouge = rouge_metric.compute(predictions=predictions, references=labels, rouge_types=["rouge1", "rouge2", "rougeL"])
